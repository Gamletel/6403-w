    ...
    <div class="quantity">
        ...
        <button class="quantityDown <?php if ($input_value == 1) { ?>quantity-disabled<?php } ?>" type="button"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="3" viewBox="0 0 14 3" fill="none">
                <path d="M1 1.5H13" stroke="var(--stroke)" stroke-width="2" stroke-linecap="round"
        ...
        <!--        <span class="p2 product-amount" id="--><?php //echo esc_attr($input_id); ?><!--">-->
        <?php //echo esc_attr($input_value); ?><!--</span>-->

        <button class="quantityUp" type="button" onclick="cChangeValue('<?php echo esc_attr($input_id); ?>',0);">
            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="15" viewBox="0 0 14 15" fill="none">
                <path d="M7 1.5V13.5M1 7.5H13" stroke="var(--stroke)" stroke-width="2" stroke-linecap="round"
                      stroke-linejoin="round"/>
            </svg>
        </button>
