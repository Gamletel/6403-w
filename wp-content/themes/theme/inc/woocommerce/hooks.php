...
//        add_action('woocommerce_after_single_product', [$this, 'product_additional_blocks'], 1); //Дополнительные блоки на странице товара
        ...
        add_action('woocommerce_cart_totals_after_order_total', [$this, 'print_cart_weight'], 10);//Вывод общей массы товаров в корзине
        add_action('woocommerce_cart_totals_after_order_total', [$this, 'print_cart_volume'], 10);//Вывод общего объема товаров в корзине
