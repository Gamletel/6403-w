...
class PagesBlock
{
	...
	public function _register()
	{
		acf_register_block_type(
			array(
				'name'              => 'pages-block',
				'title'             => 'Блок: Страницы',
				'description'       => 'Блок с ссылками на страницы',
				// 'post_types'        => array(),
	...
	public function _enqueue_assets()
	{
		...
		wp_enqueue_style('theme/pages-block',GSE()::theme_uri().$path.'/block.css',array(),2);
		wp_enqueue_script('theme/pages-block',GSE()::theme_uri().$path.'/block.js',array(),2);
		return;
	}
