...
class FAQBlock
{
	...
	public function _register()
	{
		acf_register_block_type(
			array(
				'name'              => 'faq-block',
				'title'             => 'Блок: Вопросы',
				'description'       => 'Блок с вопросами и ответами',
				// 'post_types'        => array(),
	...
	public function _enqueue_assets()
	{
		...
		wp_enqueue_style('theme/faq-block',GSE()::theme_uri().$path.'/block.css',array(),2);
		wp_enqueue_script('theme/faq-block',GSE()::theme_uri().$path.'/block.js',array(),2);
		return;
	}
