<?php
class AdvantagesWithIconsBlock
{
	...
	public function _register()
	{
		acf_register_block_type(
			array(
				'name'              => 'advantages-icons-block',
				'title'             => 'Блок: Преимущества с иконками',
	...
	public function _enqueue_assets()
	{
		...
		wp_enqueue_style('theme/advantages-icons-block',GSE()::theme_uri().$path.'/block.css',array(),2);
		wp_enqueue_script('theme/advantages-icons-block',GSE()::theme_uri().$path.'/block.js',array(),2);
		return;
	}
...
return new AdvantagesWithIconsBlock();
?>